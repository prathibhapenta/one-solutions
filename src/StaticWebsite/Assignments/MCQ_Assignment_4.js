...
const MCQ_Assignment4 = () => {
  const originalQuestions = [
    ...
    },
    {
      ...
      options: ["font-style", "text-style", "font-italic", "text-italic"],
      answer: "font-style",
    },
    // ---------- CSS Box Model ----------
    {
      question: "Which CSS property sets the width of an element’s border?",
      options: ["border-width", "padding", "margin", "box-width"],
      answer: "border-width",
    },
    {
      question: "Which property is used to control the spacing inside an element?",
      options: ["padding", "margin", "border-spacing", "spacing"],
      answer: "padding",
    },
    {
      question: "Which property controls the spacing outside an element?",
      options: ["margin", "padding", "border", "spacing"],
      answer: "margin",
    },
    {
      question: "Which property is used to hide overflow content?",
      options: ["overflow", "text-overflow", "hidden", "clip"],
      answer: "overflow",
    },
    {
      question: "Which CSS property changes the display of an element to a flexible container?",
      options: ["display: flex", "flex", "display-flex", "flex-container"],
      answer: "display: flex",
    },
  ];
